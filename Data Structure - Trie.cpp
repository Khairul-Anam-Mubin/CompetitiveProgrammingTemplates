// Data Structure : Trie
// Trie , Prefix Tree , Radix Tree Implementation
// Strings matching Algorithm

#include <bits/stdc++.h>
using namespace std ;
struct node{
    bool endmark ; // this is for color the node
...
void Insert(string str , int len) {
    ...
    curr->endmark = true ; // setting the endmark after ending inserting
}
...
// Doing Recursion for free up all the memory
